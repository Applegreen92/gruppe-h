    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 5, 17, 0, 0, 0));
...
//            admin.getFriends().add(userRepository.findByUsername("test"));
            ...
            admin.setEmail("Felix.Bernardi@web.de");
            userRepository.save(admin);
            User test = new User();
            test.setName("Tester Testing");
            test.setUsername("test");
            test.setHashedPassword(passwordEncoder.encode("test"));
            test.setRoles(Collections.singleton(Role.USER));
