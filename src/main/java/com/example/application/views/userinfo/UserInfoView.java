package com.example.application.views.userinfo;
...
@PageTitle("User Info")
@Route(value = "user-info/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Uses(Icon.class)
public class UserInfoView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "user-info/%s/edit";
    ...
    @Autowired
    public UserInfoView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("user-info-view");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(UserInfoView.class);
            }
        }
    }
